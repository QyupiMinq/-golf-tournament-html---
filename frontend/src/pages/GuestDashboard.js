        ...
        {(settings.vision || settings.mission) && (
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-200">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {settings.vision && <div><h3 className="text-xl font-bold text-green-700 mb-3">VISI</h3><p className="text-gray-700 whitespace-pre-line">{settings.vision}</p></div>}
              {settings.mission && <div><h3 className="text-xl font-bold text-green-700 mb-3">MISI</h3><p className="text-gray-700 whitespace-pre-line">{settings.mission}</p></div>}
            </div>
          </div>
        )}
