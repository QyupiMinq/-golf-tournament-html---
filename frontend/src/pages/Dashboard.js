...
const Dashboard = () => {
  ...
  return (
    <div data-testid="dashboard-page" className="dark:bg-gray-900 dark:text-white transition-colors duration-300">
      ...
      <div className="sticky top-0 z-50 mb-8 bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900 dark:from-slate-950 dark:via-emerald-950 dark:to-slate-950 rounded-2xl p-8 shadow-2xl relative overflow-hidden border border-amber-500/20 dark:border-amber-600/30">
