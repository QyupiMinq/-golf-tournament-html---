...
const Dashboard = () => {
  ...
  return (
    <div data-testid="dashboard-page">
      {/* Header - Premium Dark Theme with Gold Accents */}
      <div className="mb-8 bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900 rounded-2xl p-8 shadow-2xl relative overflow-hidden border border-amber-500/20">
